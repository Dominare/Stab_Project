...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_connect.clicked.connect(MainWindow.Conect_clicked) # type: ignore
        self.pushButton.clicked.connect(MainWindow.Send) # type: ignore
        self.horizontalSlider.sliderMoved['int'].connect(MainWindow.changing) # type: ignore
        self.pushButton_2.clicked.connect(MainWindow.addplot) # type: ignore
        self.pushButton_3.clicked.connect(MainWindow.removeplot) # type: ignore
